...
router.post('/prescription-simplify', aiController.simplifyMedication);
router.post('/triage-assist', aiController.runTriageAssistant);
router.post('/reminder-text', aiController.generateReminderText);
router.post('/reminder-message', aiController.generateReminderText);
router.post('/referral-summary', aiController.generateReferralSummary);
router.post('/async-reply-suggest', aiController.suggestAsyncReply);
